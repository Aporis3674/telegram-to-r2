...
> **بات تلگرامی که فایل‌هات رو روی Backblaze B2 (فضای ابری رایگان) ذخیره میکنه**
> کافیه فایل رو به بات بفرستی — لینک دانلود مستقیم برمیگردونه
...
| لینک موقت | لینک دانلود با تاریخ انقضا بساز (مثلاً 24 ساعته) |
...
| پنل ادمین | بلاک/آنبلاک کاربر، آمار کل، مدیریت فایل‌ها |
...
4. **Node.js** نسخه 18 یا بالاتر — [nodejs.org](https://nodejs.org)
...
5. **توکن بات رو کپی کن** — چیزی شبیه اینه: `7123456789:***`
...
آدرس `https://your-worker-name.workers.dev/upload` رو توی مرورگر باز کن. رمزی که توی قدم 7 تنظیم کردی رو وارد کن و فایل‌هات رو آپلود کن. این صفحه محدودیت حجم نداره.
